...
public class TestApprox {
  ...
  @Test public void testApprox8() {
    ...
    TypeStruct tfp0_args = TypeStruct.make("", true, TypeFlds.ts(TypeFld.DISP), false);

    TypeFunPtr tfp0 = TypeFunPtr.make(BitsFun.ANY,2,(TypeMemPtr)TypeFunPtr.DISP.simple_ptr()); // fib with generic display
    TypeStruct dsp0 = TypeStruct.make(TypeFld.DISP,TypeFld.make("fib",tfp0,1));// The display with weak fib-type
    ...
    TypeStruct dsp1 = TypeStruct.make(TypeFld.DISP,TypeFld.make("fib",tfp1,1)); // Display with stronger FIB-type
    ...
    TypeStruct dsp2 = TypeStruct.make(TypeFld.DISP,TypeFld.make("fib",tfp2,1)); // dsp2->fib2->dsp1->fib1->dsp0->fib0->generic_display
